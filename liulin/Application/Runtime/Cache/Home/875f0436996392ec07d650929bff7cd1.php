...
<div class="container">
	...
	<div  class="col-md-10 col-md-offset-1"s>
		<form class="form-horizontal" action="<?php echo U('Home/Uinfo/upload');?>" enctype="multipart/form-data" method="post"> 
			<div class="form-group"> 
				<div class="col-sm-offset-1 col-sm-10">
					<img src="<?php echo $head;?>" style="width: 160px;height: 160px;margin-top: 50px;"><?php var_dump($head);?>
				</div>
			</div>
			<div class="form-group"> 
				<div class="col-sm-offset-1 col-sm-10">
