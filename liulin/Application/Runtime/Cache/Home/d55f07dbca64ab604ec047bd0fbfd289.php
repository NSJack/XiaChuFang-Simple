...
<body>
	...
	<div class="col-md-10 col-md-offset-1" style="margin-top: 50px;">
		...
		<div>
			<!--如果菜谱id不为空-->
			<?php if(!empty($arr['0'])): ?><div style="font-size: 16px;line-height: 36px;font-family: sans-serif;">
			...
			<!--菜谱id为空-->
			<?php if(empty($arr['0'])): ?><div style="text-align: center;margin-top: 100px;font-size: 16px;line-height: 1.8;">
