		...
		$(document).ready(function(){
			...
			$("#username").blur(function(){		
				...
				if( !username_reg.test(username) ){
					...
					$.ajax({
						//请求的URL
						url:"<?php echo U('Register/Register_username/');?>",
						//请求的类型
						type:'post',
						//同步或异步
						async:true,
...
<div class="container">
	...
	<a href="<?php echo U('Admin/Login/index');?>" style="margin-top: 30px;float: right;"><font color="#dd3915" size="4x">登录</font></a>
	...
	<div class="col-md-6 col-md-offset-4">
		...
		<div style="margin-top: 60px;">
			<form action="<?php echo U('Admin/Register/index?do=check'); ?>" method="post" class="form-horizontal" onsubmit="return check();">
