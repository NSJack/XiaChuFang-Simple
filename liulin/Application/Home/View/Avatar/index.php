...
<block name="content">
	...
	<div  class="col-md-10 col-md-offset-1" style="margin-top: 20px;">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('Home/Avatar/index');?>"><font color="black" size="3x">设置头像</font></a></li>
	...
	<div  class="col-md-10 col-md-offset-1">
		<form class="form-horizontal" action="<?php echo U('Home/Avatar/upload');?>" enctype="multipart/form-data" method="post"> 
