	...
	<div class="col-md-10 col-md-offset-1" style="margin-top: 15px;">
		...
		<form  class="form-horizontal" action="<?php echo U('Home/Dish/editSave',array('did'=>$dishFind['did'])); ?>" method="post" enctype="multipart/form-data" name="">
			<div id="left"  class="col-sm-9" style="float: left;">
				...
				<div>
					<input type="text" id="dishname" class="form-control" name="dishname" placeholder="添加菜谱名称" style="height: 60px;background: #fffce9;outline:none;border: 0;font-size: 35px;font-weight: bold;" value="<?php echo $dishFind['dishname'];?>">
				</div>
			
				<!--点击上传菜谱封面-->			
				<div>
					
					<label for="file" id="file1"><img src="__ROOT__/<?php echo $dishFind['dishcover']; ?>" style="width: 100%;height: 488px;margin-top: 20px;"></label>
					<input type="file" id="file" name="dishcover" style="display: none" value="__ROOT__/<?php echo $dishFind['dishcover']; ?>"/> 
				...
				<div style="margin-top: 20px;outline:none">
					...
					<div style="width: 100%;border-right: 0;margin-top: 20px" name="materials"  id="optionContainer">
						...
						<div id="one">
							<div id="option">						    
						    	...
						    	<input type="text" id="dosage" name="dosage[]" style="width: 47%;height: 60px;font-size: 16px;border:2px;outline: none;border-style:none;float: left;" class="form-control" placeholder="用量：如一只" value="<?php echo $dstu['dosage']; ?>">
					...
					<script>
						//用料的添加和删除
						var i=<?php echo $countDishStuff;?>; console.log(i);
						var html = "<div>";
						html += "<div id='option'>";
				...
				<div style="outline:none;height: 190px;background: #f5f6f5;"><br>
					...
					<textarea class="form-control" id="authmsg" name="authmsg" style="width: 93%;outline:none;background: #f5f6f5;margin-left: 20px;margin-top: 20px;" rows="3" placeholder="点击添加小贴士"><?php echo $dishFind['authmsg'];?></textarea>
				</div>		
